...
regional reanalysis focussing on the Arctic regions\todo{HA not only used for
  this}. It is one of the canonical model configurations of the ALADIN-HIRLAM
...
preparation)\todo{reference for GPROF needed}.
...
case can be fairly well approximated by scaling TRO data.\todo{The database
  part can be shorter if necessary}
