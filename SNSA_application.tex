...
QRNN is already available as a part of the Typhon software
package \citep{lemke:2020:typhon}. The implementation of the retrieval algorithm shall be relatively straightforward but it will be important to find the neural-network architecture required to achieve the best model performance. Additionally, the retrieval sensitivity to different auxiliary data would be analysed. In order to run the retrievals, we shall make use of the Chalmers central computational cluster (C3SE).
